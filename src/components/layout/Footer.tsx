    ...
    <footer className="bg-primary-900 text-neutral-300">
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-6 flex gap-4">
              {company.socialLinks.instagram && (
                <a href={company.socialLinks.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram"
              ...
              {company.socialLinks.facebook && (
                <a href={company.socialLinks.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook"
                  className="text-neutral-300 hover:text-accent-400 transition-colors">
                  <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
              ...
              {company.socialLinks.linkedin && (
                <a href={company.socialLinks.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"
                  className="text-neutral-300 hover:text-accent-400 transition-colors">
                  <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Services */}
          <div>
            <h3 className="mb-5 text-xs font-semibold uppercase tracking-widest text-neutral-300">
              Nos Services
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-neutral-300">
              ...
              <li className="text-neutral-300">{company.hours}</li>
            </ul>
          </div>
        </div>

        {/* Bottom bar */}
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-neutral-300">
